...
4.  PROVIDERNAME		VARCHAR2(255)	Taxi Company that Provided 								trip	<br>
...
10. TOTALAMOUNT		VARCHAR2(255)	Total amount from Meter 								fare, tip, surcharge, 								extras, and tolls. <br>
...
19. DURATION			VARCHAR2(255)	Trip time - duration of 								travel <br>
...
22. RIGIN_BLOCKNAME		VARCHAR2(255)	Pick up location street 								block name <br>
...
25. DESTINATION_BLOCKNAME	VARCHAR2(255)	Drop off location street 								block name <br>
26. AIRPORT			CHAR(1)		Pick up or drop off 									location is a local airport 							(Y/N) <br>
