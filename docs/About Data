...
The data consist of 12 files which determines each month trips
...
Cash
EHail
Other (not sure how common this is)
Uber (not sure how common this is)

Trip Type:

Ordinal (normal rate)
VoD
TransportDC (grant program)
TransportDCShared (grant program)
MOVA (grant program)
CFSA (grant program)
NRS (grant program)
NEMT (grant program)
